...
const dict = {
  en: {
    ...
    plan1_f1: 'Up to 5 products',
    plan1_f2: 'Up to 5 orders a day',
    plan1_f3: '900 visits a month',
    plan1_f4: 'Up to 5 photos',
    plan1_f5: '1 staff account',
    plan1_f6: '1 storefront theme',

    plan2_name: 'Basic',
    plan2_price: 'Contact us',
    plan2_tag: 'For shops ready to sell full time.',
    plan2_cta: 'Contact us',
    plan2_f1: 'Unlimited products',
    plan2_f2: 'Unlimited orders',
    plan2_f3: '80,000 visits a month',
    plan2_f4: 'Unlimited photos',
    plan2_f5: '2 staff accounts',
    plan2_f6: '5 storefront themes',
    plan2_f7: 'Custom domain',

    plan3_name: 'Starter',
    plan3_badge: 'Most popular',
    plan3_price: 'Contact us',
    plan3_tag: 'For growing shops that need more room.',
    plan3_cta: 'Contact us',
    plan3_f1: 'Unlimited products',
    plan3_f2: 'Unlimited orders',
    plan3_f3: '200,000 visits a month',
    plan3_f4: 'Unlimited photos',
    plan3_f5: '4 staff accounts',
    plan3_f6: '10 storefront themes',
    plan3_f7: 'Custom domain',

    plan4_name: 'Advance',
    plan4_price: 'Contact us',
    plan4_tag: 'For big or multi-shop sellers.',
    plan4_cta: 'Talk to us',
    plan4_f1: 'Unlimited products',
    plan4_f2: 'Unlimited orders',
    plan4_f3: 'Unlimited visits',
    plan4_f4: 'Unlimited photos',
    plan4_f5: 'Unlimited staff accounts',
    plan4_f6: 'Every storefront theme',
    plan4_f7: 'LMS & POS systems included',
  ...
  bn: {
    ...
    plan1_f1: '৫টা পর্যন্ত প্রোডাক্ট',
    plan1_f2: 'দৈনিক ৫টা পর্যন্ত অর্ডার',
    plan1_f3: 'মাসে ৯০০ ভিজিট',
    plan1_f4: '৫টা পর্যন্ত ছবি',
    plan1_f5: '১টা স্টাফ অ্যাকাউন্ট',
    plan1_f6: '১টা স্টোরফ্রন্ট থিম',

    plan2_name: 'বেসিক',
    plan2_price: 'যোগাযোগ করুন',
    plan2_tag: 'পুরোদমে বিক্রি শুরু করতে চান যারা।',
    plan2_cta: 'যোগাযোগ করুন',
    plan2_f1: 'আনলিমিটেড প্রোডাক্ট',
    plan2_f2: 'আনলিমিটেড অর্ডার',
    plan2_f3: 'মাসে ৮০,০০০ ভিজিট',
    plan2_f4: 'আনলিমিটেড ছবি',
    plan2_f5: '২টা স্টাফ অ্যাকাউন্ট',
    plan2_f6: '৫টা স্টোরফ্রন্ট থিম',
    plan2_f7: 'কাস্টম ডোমেইন',

    plan3_name: 'স্টার্টার',
    plan3_badge: 'সবচেয়ে জনপ্রিয়',
    plan3_price: 'যোগাযোগ করুন',
    plan3_tag: 'আরও জায়গা দরকার এমন বড় হতে থাকা দোকানের জন্য।',
    plan3_cta: 'যোগাযোগ করুন',
    plan3_f1: 'আনলিমিটেড প্রোডাক্ট',
    plan3_f2: 'আনলিমিটেড অর্ডার',
    plan3_f3: 'মাসে ২,০০,০০০ ভিজিট',
    plan3_f4: 'আনলিমিটেড ছবি',
    plan3_f5: '৪টা স্টাফ অ্যাকাউন্ট',
    plan3_f6: '১০টা স্টোরফ্রন্ট থিম',
    plan3_f7: 'কাস্টম ডোমেইন',

    plan4_name: 'অ্যাডভান্স',
    plan4_price: 'যোগাযোগ করুন',
    plan4_tag: 'বড় বা একাধিক দোকানের জন্য।',
    plan4_cta: 'কথা বলুন',
    plan4_f1: 'আনলিমিটেড প্রোডাক্ট',
    plan4_f2: 'আনলিমিটেড অর্ডার',
    plan4_f3: 'আনলিমিটেড ভিজিট',
    plan4_f4: 'আনলিমিটেড ছবি',
    plan4_f5: 'আনলিমিটেড স্টাফ অ্যাকাউন্ট',
    plan4_f6: 'সব স্টোরফ্রন্ট থিম',
    plan4_f7: 'LMS ও POS সিস্টেম সহ',
