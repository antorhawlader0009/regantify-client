...
export default function EditProduct() {
  ...
  return (
    <div className="max-w-6xl">
      <div className="sticky top-0 z-10 -mx-8 -mt-8 px-8 pt-8 pb-3 bg-regantify-content">
        <button
        ...
        <SectionCard title="Stock Information" id="stock">
          <div className="space-y-5">
            <Field label="SKU Code" required tooltip="A unique code you use to identify this product.">
              {editingSku ? (
                <input type="text" value={sku} onChange={(e) => setSku(e.target.value)} className={inputClass} autoFocus />
              ) : (
                <div className="flex gap-2">
                  <input type="text" value={sku} disabled className={`${inputClass} opacity-60`} />
                  <button
                    type="button"
